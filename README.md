...
1) How do retail sales of various alcohols compare from 2019 to 2020? What has the largest and smallest gap? Based on this data, what can we determine the impact of alcohol sales are pre-covid shelter in place versus during covid shelter in place.
    ...
    a) Analysing  societal changes in alcohol consumption from 2019 to 2020 provides insights into          lifestyle and behavioral changes during the Covid-19 pandemic. Consumer habits drastically           shifted during this transition, and by examining the most favorable alcohols during this time        can highlight how isolation influenced these habits.
...
2) How do retail sales compare to warehouse sales for each year? Can we infer that some alcohol had higher anticipated retail sales than waas actualized? Which alcohols had the highest discrepencies in this area?
    ...
    a) Inspecting the differences between retail and warehouse sales during this time can highlight         supply shortages, poor demand prediction, and/or overall consumption declines. Through               looking at these analyses, we can further understand how businesses adapted during this time. 
